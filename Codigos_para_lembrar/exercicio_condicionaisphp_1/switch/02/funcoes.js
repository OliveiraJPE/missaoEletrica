// window.alert('Funções são ações que são chamadas ou em decorrência de um evento. Pode receber prametro e retornar um resultado.');
...
function parimp(){
var n=window.document.getElementById('parimp');
