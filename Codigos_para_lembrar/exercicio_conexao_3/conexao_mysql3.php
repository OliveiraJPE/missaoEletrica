...
if(!$_con) { // ou if(mysqli_connect_errno()!=0) {
echo "Não foi possível conectar ao MySQL. Erro #" . mysqli_connect_errno() . " : " . mysql_connect_error(); 
exit;
} 
...
if(!$_con->multi_query($_sql)) {
    echo "Erro na consulta... " . $_con->error . "<br/>"; 
        ...
        $_af = $_con->affected_rows; echo "Número de registros afetados... $_af <br/>"; 
...
echo "Número de registros afetados... $_af <br/>";
