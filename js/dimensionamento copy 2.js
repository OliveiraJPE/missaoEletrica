...
function dimensCircCC() {
  ...
  function Circ(CTipoCC, IscModCC, Iocp, disj, DPS1) {
    if (
      (Number.parseFloat(CTipoCC) - 1) * Number.parseFloat(IscModCC) >
      Number.parseFloat(Iocp)
    ) {
      if (1.5 * IscModCC < disj < 2.4 * nIscModCC && nomeDisj < Iocpr) {
        alert(
          `Disjuntor ou Fusível gPV (com seccionador ou não) deve ser de ${disj}A.`
        );
      } else {
        alert(
      ...
      alert(
        `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS1.toFixed(
          0
        )}V, e  ${disj}A.`
      );
    }
  ...
  if (nCircTipoCC == 2) {
    ...
    //Chamando a função Circ
    Circ(nCircTipoCC, nIscModCC, Iocpr, nomeDisj1, DPS);

    //Chamando a função Circ
    Circ(nCircTipoCC, nIscModCC, Iocpr, nomeDisj2, DPS);
    ...
    if (nomeDisj1 == 0 || nomeFio1 == 0 || nomeDisj2 == 0 || nomeFio2 == 0) {
      ...
      alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, corrente de projeto IB1 = ${IBcc1.toFixed(
          2
        )}A,  com L1 = ${ntrecho1} metros, corrente de projeto IB2 = ${IBcc2.toFixed(
          2
  ...
  if (nCircTipoCC == 3) {
    ...
    Circ(nCircTipoCC, nIscModCC, Iocpr, nomeDisj2, DPS);
    //Chamando a função Circ
    Circ(nCircTipoCC, nIscModCC, Iocpr, nomeDisj3, DPS);
    ...
    if (
      ...
      alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, corrente de projeto IB1 = ${IBcc1.toFixed(
          ...
          2
        )}A,  com L2 = ${ntrecho2} metros, corrente de projeto IB3 = ${IBcc3.toFixed(
          2
  ...
  if (nCircTipoCC == 4) {
    ...
    Circ(nCircTipoCC, nIscModCC, Iocpr, nomeDisj3, DPS);
    //Chamando a função Circ
    Circ(nCircTipoCC, nIscModCC, Iocpr, nomeDisj4, DPS);
    //Chamando a função Circ
    Circ(nCircTipoCC, nIscModCC, Iocpr, nomeDisj5, DPS);
    //Chamando a função Circ
    Circ(nCircTipoCC, nIscModCC, Iocpr, nomeDisj6, DPS);
    //Chamando a função Circ
    Circ(nCircTipoCC, nIscModCC, Iocpr, nomeDisj7, DPS);
    if (
      nomeDisj1 == 0 ||
      nomeFio1 == 0 ||
      nomeDisj2 == 0 ||
      ...
      alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, corrente de projeto IB1 = ${IBcc1.toFixed(
          ...
          2
        )}A,  com L3 = ${ntrecho3} metros, corrente de projeto IB4 = ${IBcc4.toFixed(
          2
        )}A,  com L4 = ${ntrecho4} metros, a corrente de projeto IB5 = ${IBcc5.toFixed(
          2
        )}A,  com L5 = ${ntrecho5} metros, corrente de projeto IB6 = ${IBcc6.toFixed(
          2
        )}A,  com L6 = ${ntrecho6} metros, e a corrente de projeto IB7 = ${IBcc7.toFixed(
          2
