...
while (nomeFio5>=nomeFio6){
  ...
  if(mark==1){
    if (((mark - 1) * nIscModCC)> Iocpr) {
      if(nomeDisj1>nISC15){
        ...
        alert("ERRO: Disjuntor ou Fusível gPV Maior do que 2,4 x Isc Mod..");
       }
      }else{alert("ERRO: Disjuntor ou Fusível gPV menor do que 1,5 x Isc Mod.");
    } 
    }else{
      alert(
    ...
    if (((mark - 1) * nIscModCC) > Iocpr) {
      if(nomeDisj2>nISC15){
        ...
        alert("ERRO: Disjuntor ou Fusível gPV, para a série 01, Maior do que 2,4 x Isc Mod..");
       }
      }else{alert("ERRO: Disjuntor ou Fusível gPV, para a série 01, menor do que 1,5 x Isc Mod.");
    } 
    ...
    if(nomeDisj3>nISC15){
      ...
      alert("ERRO: Disjuntor ou Fusível gPV, para a série 02, Maior do que 2,4 x Isc Mod..");
     }
    }else{alert("ERRO: Disjuntor ou Fusível gPV, para a série 02, menor do que 1,5 x Isc Mod.");
  } 
  ...
  if(nomeDisj6>nISC15){
    if(nomeDisj6< nISC24){
      ...
      alert("ERRO: Disjuntor ou Fusível gPV, para o geral do arranjo, Maior do que a máxima corrrente reversa. ");
  }
}else{
    alert("ERRO: Disjuntor ou Fusível gPV, para o geral do arranjo, Maior do que 2,4 x Isc Mod..");
   }
  }else{alert("ERRO: Disjuntor ou Fusível gPV, para o geral do arranjo, menor do que 1,5 x Isc Mod.");
} 
    ...
    if(nomeDisj9>nISC15){
      if(nomeDisj9< nISC24){
        ...
        alert("ERRO: Disjuntor ou Fusível gPV, para o subarranjo 01, Maior do que a máxima corrrente reversa. ");
    }
  }else{
      alert("ERRO: Disjuntor ou Fusível gPV, para o subarranjo 01, Maior do que 2,4 x Isc Mod..");
     }
    }else{alert("ERRO: Disjuntor ou Fusível gPV, para o subarranjo 01, menor do que 1,5 x Isc Mod.");
  } 
  if(nomeDisj10>nISC15){
    ...
    alert("ERRO: Disjuntor ou Fusível gPV, para a série 03, Maior do que 2,4 x Isc Mod..");
   }
  }else{alert("ERRO: Disjuntor ou Fusível gPV, para a série 03, menor do que 1,5 x Isc Mod.");
} 
if(nomeDisj11>nISC15){
  ...
  alert("ERRO: Disjuntor ou Fusível gPV, para a série 04, Maior do que 2,4 x Isc Mod..");
 }
}else{alert("ERRO: Disjuntor ou Fusível gPV, para a série 04, menor do que 1,5 x Isc Mod.");
} 
if(nomeDisj12>nISC15){
  if(nomeDisj12< nISC24){
    ...
    alert("ERRO: Disjuntor ou Fusível gPV, para o subarranjo 02, Maior do que a máxima corrrente reversa. ");
}
}else{
  alert("ERRO: Disjuntor ou Fusível gPV, para o subarranjo 02, Maior do que 2,4 x Isc Mod..");
 }
}else{alert("ERRO: Disjuntor ou Fusível gPV, , para o subarranjo 02, menor do que 1,5 x Isc Mod.");
} 
