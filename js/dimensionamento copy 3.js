...
<form action="">
    ...
    <p>Obs.:O Padrão adotado pelo sistema foi ${padrao}. Escolha a tensão em função o padrão. Se UM1 0u UM2 a única opção é 127V, se UB1 ou UB2 as opções são 127V ou 220V, e se T1 ou T2 as opções são 127V, 220V - Bifásico ou 220V - Trifásico.</p><br>
    <br><input type="number" name="tue1V" id="tue1V" value="0"> <label> Tensão para esta carga.</label><br>
