...
function dimensCircCC() {
  ...
  function protfio(IBcc, Scc) {
    if (IBcc < 10 && Scc <= 1.5) {
      ...
      alert(
        "ERRO: Ampacidade - Condutor maior do que 70mm², procure um Técnico ou refaça a operação ou Disjuntor maior do que a capacidade do condutor de 70mm², procure um Técnico ou refaça a operação"
      );
  ...
  if (nCircTipoCC == 1) {
    ...
    Scc1 = Number.parseFloat((ntrecho1 * IBcc1) / (44 * 0.03 * VMaxTotal));
    DPS = 1.1 * VocTotal;
  ...
  if (nCircTipoCC == 2) {
    ...
    Scc2 = (ntrecho1 * IBcc2) / (44 * 0.03 * VMaxTotal);
    Scc3 = (ntrecho2 * IBcc3) / (44 * 0.03 * VMaxTotal);
    DPS = 1.1 * VocTotal;
  ...
  if (nCircTipoCC == 3) {
    ...
    IBcc6 = IBcc4 + IBcc5;
    Scc4 = (ntrecho1 * IBcc4) / (44 * 0.03 * VMaxTotal);
    Scc5 = (ntrecho2 * IBcc5) / (44 * 0.03 * VMaxTotal);
    Scc6 = (ntrecho3 * IBcc6) / (44 * 0.03 * VMaxTotal);
  ...
  if (nCircTipoCC == 4) {
    ...
    //IBcc5
    Scc7 = (ntrecho1 * IBcc7) / (44 * 0.03 * VMaxTotal);
    Scc8 = (ntrecho2 * IBcc8) / (44 * 0.03 * VMaxTotal);
    Scc11 = (ntrecho5 * IBcc11) / (44 * 0.03 * VMaxTotal);
    ...
    //Ibcc6
    Scc9 = (ntrecho3 * IBcc9) / (44 * 0.03 * VMaxTotal);
    Scc10 = (ntrecho4 * IBcc10) / (44 * 0.03 * VMaxTotal);
    Scc12 = (ntrecho6 * IBcc12) / (44 * 0.03 * VMaxTotal);
    ...
    //IBcc7
    Scc13 = (ntrecho7 * IBcc13) / (44 * 0.03 * VMaxTotal);
    ...
    resDisJFio10 = protfio(IBcc10, Scc410);
  ...
  if(mark==1){
    ...
    if (
      (1 - 1) * Number.parseFloat(nIscModCC) >
      Number.parseFloat(Iocpr)
    ) {
      if (1.5 * nIscModCC < nomeDisj1 < 2.4 * nIscModCC && nomeDisj1 < Iocpr) {
        alert(
          `Disjuntor ou Fusível gPV (com seccionador ou não) deve ser de ${nomeDisj1}A.`
        );
      } else {
        alert(
          "Disjuntor ou Fusível gPV não é possível de ser calculado a partir do relecionamento dos parametros inseridos."
        );
      }
    } else {
      alert(
        `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(
          0
        )}V, e  ${nomeDisj1}A.`
      );
    }
    if (nomeDisj1 == 0 || nomeFio1 == 0) {
      alert(
        "ERRO: Condutor superou 70mm² em, pelo menos, um dos critérios de dimensionamento. Consulte um técnico ou refaça o dimensionamento."
      );
    } else {
      alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, corrente de projeto IB1 = ${IBcc1.toFixed(
          2
        )}A,  com L1 = ${ntrecho1} metros. \n-->O condutor para trecho 01 de ${nomeFio1} mm². \n-->O DPS deve ter valor maior do que ${DPS.toFixed(
0
    ...
    if (
      (2 - 1) * Number.parseFloat(nIscModCC) >
      Number.parseFloat(Iocpr)
    ) {
      if ((1.5 * nIscModCC < nomeDisj2 < 2.4 * nIscModCC && nomeDisj2 < Iocpr) || (1.5 * nIscModCC < nomeDisj3 < 2.4 * nIscModCC && nomeDisj3 < Iocpr)){
        alert(
          `Disjuntor ou Fusível gPV (com seccionador ou não) para o CKT 1: deve ser de ${nomeDisj2}A, e para o CKT 2: deve ser de ${nomeDisj3}A.`
        );
      } else {
        alert(
          "Disjuntor ou Fusível gPV não é possível de ser calculado a partir do relecionamento dos parametros inseridos."
      ...
      if(nomeDisj2<nomeDisj3){disj=nomeDisj3;}else{disj=nomeDisj2;}
      alert(
        `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(
          0
        )}V, e  ${disj}A.`
    ...
    if (nomeDisj2 == 0 || nomeFio2 == 0 || nomeDisj3 == 0 || nomeFio3 == 0) {
      alert(
        "ERRO: Condutor superou 70mm² em, pelo menos, um dos critérios de dimensionamento. Consulte um técnico ou refaça o dimensionamento."
      );
    } else {
      ...
      alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, corrente de projeto IB1 = ${IBcc2.toFixed(
          2
        )}A,  com L1 = ${ntrecho1} metros, corrente de projeto IB2 = ${IBcc3.toFixed(
          2
        )}A,  com L2 = ${ntrecho2} metros. \n-->O condutor para trecho 01 de ${nomeFio2} mm²; para o trecho 02 de ${nomeFio3} mm².  \n-->O DPS deve ter valor maior do que ${DPS.toFixed(
          0
        )}V, Classe II. \n-->OBS.:Em caso de possibilidade de descagas atmosféricas, ou distância entre o sistema e o quadro CC maior do que 10m, consulte um Técnico ou Engenheiro para o dimensionamento do DPS e Sistema de aterramento.`
      );
    }
    ...
    if ((1.25 * nIscModCC < nomeDisj4 < 2.4 * nIscModCC && nomeDisj4 < Iocpr) || (1.5 * nIscModCC < nomeDisj5 < 2.4 * nIscModCC && nomeDisj5 < Iocpr) || (1.5 * nIscModCC < nomeDisj6 < 2.4 * nIscModCC && nomeDisj6 < Iocpr)){
      alert(
        `Disjuntor ou Fusível gPV (com seccionador ou não) para o CKT 1 - SubArranjo: deve ser de ${nomeDisj4}A, para o CKT 2 - SubArranjo: deve ser de ${nomeDisj5}A, e para o CKT 3 - Arranjo : deve ser de ${nomeDisj6}A.`
      );
    } else {
      alert(
        "Disjuntor ou Fusível gPV não é possível de ser calculado a partir do relecionamento dos parametros inseridos."
    ...
    if(nomeDisj4>nomeDisj5 && nomeDisj4>nomeDisj6 ){disj=nomeDisj4;}else if(nomeDisj5>nomeDisj4 && nomeDisj5>nomeDisj6 ){disj=nomeDisj5;}else if(nomeDisj6>nomeDisj4 && nomeDisj6>nomeDisj5 ){disj=nomeDisj6;}
    alert(
      `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(
        0
      )}V, e  ${disj}A.`
    ...
    if (
      ...
      alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, corrente de projeto IB1 = ${IBcc4.toFixed(
          2
        )}A,  com L1 = ${ntrecho1} metros, corrente de projeto IB2 = ${IBcc5.toFixed(
          2
        )}A,  com L2 = ${ntrecho2} metros, corrente de projeto IB3 = ${IBcc6.toFixed(
          2
        )}A,  com L3 = ${ntrecho3} metros. \n-->O condutor para trecho 01 de ${nomeFio4} mm²; para o trecho 02 de ${nomeFio5} mm², o condutor para trecho 3 de ${nomeFio6} mm².  \n-->O DPS deve ter valor maior do que ${DPS.toFixed(
          0
        )}V, Classe II. \n-->OBS.:Em caso de possibilidade de descagas atmosféricas, ou distância entre o sistema e o quadro CC maior do que 10m, consulte um Técnico ou Engenheiro para o dimensionamento do DPS e Sistema de aterramento.`
      );
    }
    ...
    if (
      (4 - 1) * Number.parseFloat(nIscModCC) >
      Number.parseFloat(Iocpr)
    ) {
    if ((1.5 * nIscModCC < nomeDisj7 < 2.4 * nIscModCC && nomeDisj7 < Iocpr) || (1.5 * nIscModCC < nomeDisj8 < 2.4 * nIscModCC && nomeDisj8 < Iocpr) || (1.5 * nIscModCC < nomeDisj9 < 2.4 * nIscModCC && nomeDisj9 < Iocpr) || (1.5 * nIscModCC < nomeDisj10 < 2.4 * nIscModCC && nomeDisj10 < Iocpr) || (1.25 * nIscModCC < nomeDisj11 < 2.4 * nIscModCC && nomeDisj11 < Iocpr) || (1.25 * nIscModCC < nomeDisj12 < 2.4 * nIscModCC && nomeDisj12 < Iocpr) || (1.25 * nIscModCC < nomeDisj13 < 2.4 * nIscModCC && nomeDisj13 < Iocpr)){
      alert(
        `Disjuntor ou Fusível gPV (com seccionador ou não) para o CKT 1 - SubArranjo: deve ser de ${nomeDisj7}A, para o CKT 2 - SubArranjo: deve ser de ${nomeDisj8}A, para o CKT 3 - SubArranjo : deve ser de ${nomeDisj9}A, para o CKT 4 - SubArranjo: deve ser de ${nomeDisj10}A, para o CKT 5 - SubArranjo: deve ser de ${nomeDisj11}A, para o CKT 6 - SubArranjo: deve ser de ${nomeDisj12}A e para o CKT 7 - Arranjo: deve ser de ${nomeDisj13}A`
      );
    } else {
      alert(
        "Disjuntor ou Fusível gPV não é possível de ser calculado a partir do relecionamento dos parametros inseridos."
    ...
    if(nomeDisj11>nomeDisj13 && nomeDisj11>nomeDisj13 ){disj=nomeDisj11;}else if(nomeDisj12>nomeDisj11 && nomeDisj12>nomeDisj13 ){disj=nomeDisj12;}else if(nomeDisj13>nomeDisj11 && nomeDisj13>nomeDisj11 ){disj=nomeDisj13;} 
    alert(
      `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(
        0
      )}V, e  ${disj}A.`
    ...
    if (
      ...
      alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, corrente de projeto IB1 = ${IBcc7.toFixed(
          2
        )}A,  com L1 = ${ntrecho1} metros, corrente de projeto IB2 = ${IBcc8.toFixed(
          2
        )}A,  com L2 = ${ntrecho2} metros, corrente de projeto IB3 = ${IBcc9.toFixed(
          2
        )}A,  com L3 = ${ntrecho3} metros, corrente de projeto IB4 = ${IBcc10.toFixed(
          2
        )}A,  com L4 = ${ntrecho4} metros, a corrente de projeto IB5 = ${IBcc11.toFixed(
          2
        )}A,  com L5 = ${ntrecho5} metros, corrente de projeto IB6 = ${IBcc12.toFixed(
          2
        )}A,  com L6 = ${ntrecho6} metros, e a corrente de projeto IB7 = ${IBcc13.toFixed(
          2
        )}A,  com L7 = ${ntrecho7} metros. \n-->O condutor para trecho 01 de ${nomeFio7} mm²; para o trecho 02 de ${nomeFio8} mm², o condutor para trecho 3 de ${nomeFio9} mm², o condutor para o trecho 04 de ${nomeFio10} mm², para o trecho 05 de ${nomeFio11} mm², o condutor para o trecho 06 de ${nomeFio12}mm², e o condutor para o trecho 07 de ${nomeFio13} mm².  \n-->O DPS deve ter valor maior do que ${DPS.toFixed(
          0
        )}V, Classe II. \n-->OBS.:Em caso de possibilidade de descagas atmosféricas, ou distância entre o sistema e o quadro CC maior do que 10m, consulte um Técnico ou Engenheiro para o dimensionamento do DPS e Sistema de aterramento.`
      );
    }
