  ...
  function protfio(IBcc, Scc) {
    ...
    if ((IBcc < 10) && (Scc <= 1.5) ) {
      return {
        ...
        DisjProt: Number.parseFloat(10),
        CondFio: Number.parseFloat(1.5),
        
      };
    } else if ((IBcc < 16)  && (Scc <= 1.5) ) {
      return {
        DisjProt: Number.parseFloat(16),
        CondFio: Number.parseFloat(1.5),
      };
    } else if ((IBcc < 20)  && (Scc <= 2.5) ) {
      return {
        DisjProt: Number.parseFloat(20),
        CondFio: Number.parseFloat(2.5),
      };
    } else if ((IBcc < 25)  && (Scc <= 4) ) {
      return {
        DisjProt: Number.parseFloat(25),
        CondFio: Number.parseFloat(4),
      };
    } else if ((IBcc < 32)  && (Scc <= 6) ) {
      return { 
        DisjProt: Number.parseFloat(32), 
        CondFio: Number.parseFloat(6) };
    } else if ((IBcc < 40) && (Scc <= 10) ) {
      return {
        DisjProt: Number.parseFloat(40),
        CondFio: Number.parseFloat(10),
      };
    } else if ((IBcc < 45)  && (Scc <= 10) ) {
      return {
        DisjProt: Number.parseFloat(45),
        CondFio: Number.parseFloat(10),
      };
    } else if ((IBcc < 50)  && (Scc <= 16) ) {
      return {
        DisjProt: Number.parseFloat(50),
        CondFio: Number.parseFloat(16),
      };
    } else if ((IBcc < 60)  && (Scc <= 16) ) {
      return {
        DisjProt: Number.parseFloat(60),
        CondFio: Number.parseFloat(16),
      };
    } else if ((IBcc < 63)  && (Scc <= 16) ) {
      return {
        DisjProt: Number.parseFloat(63),
        CondFio: Number.parseFloat(16),
      };
    } else if ((IBcc < 80)  && (Scc <= 25)) {
      return {
        DisjProt: Number.parseFloat(80),
        CondFio: Number.parseFloat(25),
      };
    } else if ((IBcc < 90)  && (Scc <= 35) ) {
      return {
        DisjProt: Number.parseFloat(90),
        CondFio: Number.parseFloat(35),
      };
    } else if ((IBcc < 100)  && (Scc <= 35) ) {
      return {
        DisjProt: Number.parseFloat(100),
        CondFio: Number.parseFloat(35),
      };
    } else if ((IBcc < 120)  && (Scc <= 50) ) {
      return {
        DisjProt: Number.parseFloat(120),
        CondFio: Number.parseFloat(50),
      };
    } else if ((IBcc < 150)  && (Scc <= 70) ) {
      return {
        DisjProt: Number.parseFloat(150),
        CondFio: Number.parseFloat(70),
      };
    } else if ((IBcc < 160) && (Scc <= 95) ) {
      return {
        DisjProt: Number.parseFloat(160),
        CondFio: Number.parseFloat(95),
      };
    } else if ((IBcc < 175)  && (Scc <= 95) ) {
      return {
        DisjProt: Number.parseFloat(175),
        CondFio: Number.parseFloat(95),
      };
    } else {
      alert(
        "ERRO: Ampacidade - Condutor ou disjuntor resultou em zero ou maior do que 95mm² e 175A, reveja os dados inseridos ou  procure um Técnico."
      );
...
return Number.parseFloat((trecho * ibc) / (44 * 0.03 * Vmax));
  ...
  if (nCircTipoCC == 1) {
    ...
    IBcc1 = Number.parseFloat(1.5 * nIscModCC * 1);
    Scc1 = quedaTensao(ntrecho1, IBcc1, VMaxTotal);
    DPS = 1.1 * VocTotal;

    // Chamando a função protfio
    resDisJFio1 = protfio(IBcc1, Scc1);
  ...
  if (nCircTipoCC == 3) {
    ...
    if (Scc4 > Scc5 && Scc4 >= Scc6) {
      Scc6 = Scc4 + 1;
    }
    if (Scc5 > Scc4 && Scc5 >= Scc6) {
      Scc6 = Scc5 + 1;
    }
    if (Scc5 === Scc6 && Scc4 >= Scc6) {
      Scc6 = Scc4 + 1;
    }
    DPS = 1.1 * VocTotal;

    // Chamando a função protfio
    resDisJFio4 = protfio(IBcc4, Scc4);
    nomeDisj4 = resDisJFio4.DisjProt;
    nomeFio4 = resDisJFio4.CondFio;

    resDisJFio5 = protfio(IBcc5, Scc5);
    nomeDisj5 = resDisJFio5.DisjProt;
    nomeFio5 = resDisJFio5.CondFio;

    resDisJFio6 = protfio(IBcc6, Scc6);
  ...
  if (nCircTipoCC == 4) {
    ...
    VocTotal = nModCC * nVocModCC;
    VMaxTotal = nModCC * nVpModCC;
    IBcc7 = IBcc8 = IBcc9 = IBcc10 = 1.25 * nIscModCC * 2;
    IBcc11 = IBcc12 = IBcc7 * 2;
    IBcc13 = IBcc11 * 2;

    //IBcc5
    Scc7 = quedaTensao(ntrecho1, IBcc7, VMaxTotal);
    Scc8 = quedaTensao(ntrecho2, IBcc8, VMaxTotal);
    Scc11 = quedaTensao(ntrecho3, IBcc11, VMaxTotal);

    if (Scc7 > Scc8 && Scc7 >= Scc11) {
      Scc11 = Scc7 + 1;
    }
    if (Scc8 > Scc7 && Scc8 >= Scc11) {
      Scc11 = Scc8 + 1;
    }
    if (Scc7 === Scc8 && Scc7 >= Scc11) {
      Scc11 = Scc7 + 1;
    ...
    //Ibcc6
    Scc9 = quedaTensao(ntrecho4, IBcc9, VMaxTotal);
    Scc10 = quedaTensao(ntrecho5, IBcc10, VMaxTotal);
    Scc12 = quedaTensao(ntrecho6, IBcc12, VMaxTotal);

    if (Scc9 > Scc10 && Scc9 >= Scc12) {
      Scc12 = Scc9 + 1;
    }
    if (Scc10 > Scc9 && Scc10 >= Scc12) {
      Scc12 = Scc10 + 1;
    }
    if (Scc10 === Scc9 && Scc9 >= Scc12) {
      Scc12 = Scc9 + 1;
    }

    //IBcc7
    Scc13 = quedaTensao(ntrecho7, IBcc13, VMaxTotal);
    if (Scc11 > Scc12 && Scc11 >= Scc13) {
      Scc13 = Scc11 + 1;
    }
    if (Scc12 > Scc11 && Scc12 >= Scc13) {
      Scc13 = Scc12 + 1;
    }
    if (Scc11 === Scc12 && Scc11 >= Scc13) {
      Scc13 = Scc11 + 1;
  ...
  if(mark==1){
    ...
    alert(
      ...
      alert(
        ...
        `Sistema ${nCircC}, com ${potTotalMod}Wp, corrente de projeto IB1 = ${IBcc2.toFixed(2)}A,  com L1 = ${ntrecho1} metros, corrente de projeto IB2 = ${IBcc3.toFixed(2)}A,  com L2 = ${ntrecho2} metros. \n-->O condutor para trecho 01 de ${nomeFio2} mm²; para o trecho 02 de ${nomeFio3} mm².  \n-->O DPS deve ter valor maior do que ${DPS.toFixed(0)}V, Classe II. \n-->OBS.:Em caso de possibilidade de descagas atmosféricas, ou distância entre o sistema e o quadro CC maior do que 10m, consulte um Técnico ou Engenheiro para o dimensionamento do DPS e Sistema de aterramento.`);
    }else if(mark==3){
    if (((2 - 1) * nIscModCC) > Iocpr) {
  ...
  if(nomeDisj6>nISC15){
    ...
    alert(
      ...
      alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, corrente de projeto IB1 = ${IBcc4.toFixed(2)}A,  com L1 = ${ntrecho1} metros, corrente de projeto IB2 = ${IBcc5.toFixed(2)}A,  com L2 = ${ntrecho2} metros, corrente de projeto IB3 = ${IBcc6.toFixed(2)}A,  com L3 = ${ntrecho3} metros. \n-->O condutor para trecho 01 de ${nomeFio4} mm²; para o trecho 02 de ${nomeFio5} mm², o condutor para trecho 3 de ${nomeFio6} mm².  \n-->O DPS deve ter valor maior do que ${DPS.toFixed(0)}V, Classe II. \n-->OBS.:Em caso de possibilidade de descagas atmosféricas, ou distância entre o sistema e o quadro CC maior do que 10m, consulte um Técnico ou Engenheiro para o dimensionamento do DPS e Sistema de aterramento.`
      );
    }else if(mark==4){
    if (((4 - 1) * nIscModCC) >Iocpr) {
        if(nomeDisj7>nISC15){
          if(nomeDisj7< nISC24){
            if(nomeDisj7<= Iocpr){
      ...
      if(nomeDisj8>nISC15){
        if(nomeDisj8< nISC24){
          if(nomeDisj8 <= Iocpr){
                  alert(`Disjuntor ou Fusível gPV (com seccionador ou não) deve ser de ${nomeDisj8}A.`);
        }else{
          alert("ERRO: Disjuntor ou Fusível gPV Maior do que a máxima corrrente reversa. ");
      }
    }else{
    ...
    if(nomeDisj9>nISC15){
      if(nomeDisj9< nISC24){
        if(nomeDisj9 <= Iocpr){
                alert(`Disjuntor ou Fusível gPV (com seccionador ou não) deve ser de ${nomeDisj9}A.`);
      }else{
        alert("ERRO: Disjuntor ou Fusível gPV Maior do que a máxima corrrente reversa. ");
    }
  }else{
  ...
  if(nomeDisj10>nISC15){
    if(nomeDisj10< nISC24){
      if(nomeDisj10 <= Iocpr){
              alert(`Disjuntor ou Fusível gPV (com seccionador ou não) deve ser de ${nomeDisj10}A.`);
    }else{
      alert("ERRO: Disjuntor ou Fusível gPV Maior do que a máxima corrrente reversa. ");
  }
}else{
...
if(nomeDisj11>nISC15){
  if(nomeDisj11< nISC24){
    if(nomeDisj11<= Iocpr){
            alert(`Disjuntor ou Fusível gPV (com seccionador ou não) deve ser de ${nomeDisj11}A.`);
  }else{
    alert("ERRO: Disjuntor ou Fusível gPV Maior do que a máxima corrrente reversa. ");
}
}else{
...
if(nomeDisj12>nISC15){
  if(nomeDisj12< nISC24){
    if(nomeDisj12 <= Iocpr){
            alert(`Disjuntor ou Fusível gPV (com seccionador ou não) deve ser de ${nomeDisj12}A.`);
  }else{
    alert("ERRO: Disjuntor ou Fusível gPV Maior do que a máxima corrrente reversa. ");
}
}else{
...
if(nomeDisj13>nISC15){
  if(nomeDisj13< nISC24){
    if(nomeDisj13<= Iocpr){
            alert(`Disjuntor ou Fusível gPV (com seccionador ou não) deve ser de ${nomeDisj13}A.`);
  }else{
    alert("ERRO: Disjuntor ou Fusível gPV Maior do que a máxima corrrente reversa. ");
}
}else{
  alert("ERRO: Disjuntor ou Fusível gPV Maior do que 2,4 x Isc Mod..");
      ...
      alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, corrente de projeto IB1 = ${IBcc7.toFixed(2)}A,  com L1 = ${ntrecho1} metros, corrente de projeto IB2 = ${IBcc8.toFixed(2)}A,  com L2 = ${ntrecho2} metros, corrente de projeto IB3 = ${IBcc9.toFixed(2)}A,  com L3 = ${ntrecho3} metros, corrente de projeto IB4 = ${IBcc10.toFixed(2)}A,  com L4 = ${ntrecho4} metros, a corrente de projeto IB5 = ${IBcc11.toFixed(2)}A,  com L5 = ${ntrecho5} metros, corrente de projeto IB6 = ${IBcc12.toFixed(2)}A,  com L6 = ${ntrecho6} metros, e a corrente de projeto IB7 = ${IBcc13.toFixed(2)}A,  com L7 = ${ntrecho7} metros. \n-->O condutor para trecho 01 de ${nomeFio7} mm²; para o trecho 02 de ${nomeFio8} mm², o condutor para trecho 3 de ${nomeFio9} mm², o condutor para o trecho 04 de ${nomeFio10} mm², para o trecho 05 de ${nomeFio11} mm², o condutor para o trecho 06 de ${nomeFio12}mm², e o condutor para o trecho 07 de ${nomeFio13} mm².  \n-->O DPS deve ter valor maior do que ${DPS.toFixed(0)}V, Classe II. \n-->OBS.:Em caso de possibilidade de descagas atmosféricas, ou distância entre o sistema e o quadro CC maior do que 10m, consulte um Técnico ou Engenheiro para o dimensionamento do DPS e Sistema de aterramento.`);
    }
} 
