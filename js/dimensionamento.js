...
//Dimensionamento de condutores e proteção solar
var nCircC = 0;
var nCircTipoCC = 0;
var nModCC = 0;
var nPotModCC = 0;
...
function dimensCircCC() {
  /************************************************************** */
  alert(
    `ATENÇÃO: Este dimensionamento segue as NBR's 16612, 16690 e 5410,  considera a geração como circuitos de força (mínimo 2,5mm²), e os condutores solares no modo de instalação - M1: dois cabos unipolares encostados um ao outro na horizontal, instalados ao ar livre exposta ao sol, 50ºC(ar) e temperatura do condutor em regime permanente de 90ºC -  Tabela C.4.(NBR16612), até 95mm² e máxima queda de tensão admissível entre o quadro e a carga de 3%. \n-->Já o dimensionamento considera o nº idêntico de módulos em cada string em paralelo, os critérios de máxima corrente (Tabela C.4. NBR16612), e o critério de máxima queda de tensão admissível - S= (L x IB)/(44 x e), (Ver apostila solar).`);

  /* Dimensionamento de condutor e proteção solar */
  nCircC = window.document.querySelector("#nCircC").value;
  nCircTipoCC = window.document.querySelector("#nCircTipoCC").value;
  nModCC = window.document.querySelector("#nModCC").value;
  nPotModCC = window.document.querySelector("#nPotModCC").value;
  nVocModCC = window.document.querySelector("#nVocModCC").value;
  nVpModCC = window.document.querySelector("#nVpModCC").value;
  nIscModCC = window.document.querySelector("#nIscModCC").value;
  nIMaxModCC = window.document.querySelector("#nIMaxModCC").value;
  Iocpr = window.document.querySelector("#nIocprCC").value;
  ntrecho1 = window.document.querySelector("#ntrecho1").value;
  ntrecho2 = window.document.querySelector("#ntrecho2").value;
  ntrecho3 = window.document.querySelector("#ntrecho3").value;
  ntrecho4 = window.document.querySelector("#ntrecho4").value;
  ntrecho5 = window.document.querySelector("#ntrecho5").value;
  ntrecho6 = window.document.querySelector("#ntrecho6").value;
  ntrecho7 = window.document.querySelector("#ntrecho7").value;
  ntrecho8 = window.document.querySelector("#ntrecho8").value;
  ...
  function protfio(IBcc, Scc, disj) {
    ...
    if(Scc <= 1.5){return {CondFio: Number.parseFloat(2.5),DisjProt: Number.parseFloat(disj)};
    }else if(Scc <= 2.5){return {CondFio: Number.parseFloat(2.5), DisjProt: Number.parseFloat(disj)};
    }else if(Scc <= 4){return {CondFio: Number.parseFloat(4), DisjProt: Number.parseFloat(disj)};
    }else if(Scc <= 6){return {CondFio: Number.parseFloat(6), DisjProt: Number.parseFloat(disj)};
    }else if(Scc <= 10){return {CondFio: Number.parseFloat(10), DisjProt: Number.parseFloat(disj)};
    }else if(Scc <= 16){return {CondFio: Number.parseFloat(16), DisjProt: Number.parseFloat(disj)};
    }else if(Scc <= 25){return {CondFio: Number.parseFloat(25), DisjProt: Number.parseFloat(disj)};
    }else if(Scc <= 35){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
    }else if(Scc <= 50){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
    }else if(Scc <= 70){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
    }else if(Scc <= 95){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
    }else{alert("ERRO: Ampacidade - Condutor ou disjuntor resultou em zero ou maior do que 95mm² e 175A, reveja os dados inseridos ou  procure um Técnico." );}
    ...
    if(Scc <= 1.5){return {CondFio: Number.parseFloat(4), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 2.5){return {CondFio: Number.parseFloat(4), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 4){return {CondFio: Number.parseFloat(4), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 6){return {CondFio: Number.parseFloat(6), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 10){return {CondFio: Number.parseFloat(10), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 16){return {CondFio: Number.parseFloat(16), DisjProt: Number.parseFloat(disj)};
    ...
    if(Scc <= 1.5){return {CondFio: Number.parseFloat(6), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 2.5){return {CondFio: Number.parseFloat(6), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 4){return {CondFio: Number.parseFloat(6), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 6){return {CondFio: Number.parseFloat(6), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 10){return {CondFio: Number.parseFloat(10), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 16){return {CondFio: Number.parseFloat(16), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 25){return {CondFio: Number.parseFloat(25), DisjProt: Number.parseFloat(disj)};
    ...
    if(Scc <= 1.5){return {CondFio: Number.parseFloat(10), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 2.5){return {CondFio: Number.parseFloat(10), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 4){return {CondFio: Number.parseFloat(10), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 6){return {CondFio: Number.parseFloat(10), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 10){return {CondFio: Number.parseFloat(10), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 16){return {CondFio: Number.parseFloat(16), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 25){return {CondFio: Number.parseFloat(25), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 35){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
    ...
    if(Scc <= 1.5){return {CondFio: Number.parseFloat(16), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 2.5){return {CondFio: Number.parseFloat(16), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 4){return {CondFio: Number.parseFloat(16), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 6){return {CondFio: Number.parseFloat(16), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 10){return {CondFio: Number.parseFloat(16), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 16){return {CondFio: Number.parseFloat(16), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 25){return {CondFio: Number.parseFloat(25), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 35){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 50){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
    ...
    if(Scc <= 1.5){return {CondFio: Number.parseFloat(25), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 2.5){return {CondFio: Number.parseFloat(25), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 4){return {CondFio: Number.parseFloat(25), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 6){return {CondFio: Number.parseFloat(25), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 10){return {CondFio: Number.parseFloat(25), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 16){return {CondFio: Number.parseFloat(25), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 25){return {CondFio: Number.parseFloat(25), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 35){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 50){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 70){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
    ...
    if(Scc <= 1.5){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 2.5){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 4){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 6){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 10){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 16){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 25){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 35){return {CondFio: Number.parseFloat(35), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 50){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 70){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 95){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
    ...
    if(Scc <= 1.5){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 2.5){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 4){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 6){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 10){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 16){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 25){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 35){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 50){return {CondFio: Number.parseFloat(50), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 70){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 95){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  } else{alert("ERRO: Ampacidade - Condutor ou disjuntor resultou em zero ou maior do que 95mm² e 175A, reveja os dados inseridos ou  procure um Técnico." );}
    ...
    if(Scc <= 1.5){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 2.5){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 4){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 6){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 10){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 16){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 25){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 35){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 50){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 70){return {CondFio: Number.parseFloat(70), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 95){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  } else{alert("ERRO: Ampacidade - Condutor ou disjuntor resultou em zero ou maior do que 95mm² e 175A, reveja os dados inseridos ou  procure um Técnico." );}
  }else if (IBcc < 178){
    
    if(Scc <= 1.5){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 2.5){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 4){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 6){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 10){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 16){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 25){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 35){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 50){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 70){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  }else if(Scc <= 95){return {CondFio: Number.parseFloat(95), DisjProt: Number.parseFloat(disj)};
  }else{alert("ERRO: Ampacidade - Condutor ou disjuntor resultou em zero ou maior do que 95mm² e 175A, reveja os dados inseridos ou  procure um Técnico." );}
  }else {
      alert("ERRO: Ampacidade - Condutor ou disjuntor resultou em zero ou maior do que 95mm² e 175A, reveja os dados inseridos ou  procure um Técnico." );
      return { DisjProt: Number.parseFloat(0), CondFio: Number.parseFloat(0) };
    }
  }
...
var ibc;
var Vmax;
return Number.parseFloat((trecho * ibc) / (44 * 0.03 * Vmax));
  }

 
  // Verificando o tipo de circuito
  if (nCircTipoCC == 1) {
    nomeDis = (1.5 * nIscModCC)+1;
    // Cálculos
    potTotalMod = nModCC * nPotModCC;
    VocTotal = nModCC * nVocModCC;
    VMaxTotal = nModCC * nVpModCC;
    IBcc1 = Number.parseFloat(nomeDis + 1);
    Scc1 = quedaTensao(ntrecho1, IBcc1, VMaxTotal);
    DPS = 1.1 * VocTotal;

    // Chamando a função protfio
    
    resDisJFio1 = protfio(IBcc1, Scc1, nomeDis);
    nomeDisj1 = resDisJFio1.DisjProt;
    nomeFio1 = resDisJFio1.CondFio;
    mark = 1;
  }
  ...
  if (nCircTipoCC == 2) {
    ...
    VocTotal = nModCC * nVocModCC;
    VMaxTotal = nModCC * nVpModCC;
    IBcc2 = Number.parseFloat(nomeDis + 1);
    IBcc3 = Number.parseFloat(nomeDis + 1);
    Scc2 = quedaTensao(ntrecho1, IBcc2, VMaxTotal);
    Scc3 = quedaTensao(ntrecho2, IBcc3, VMaxTotal);
    DPS = 1.1 * VocTotal;

    // Chamando a função protfio
   resDisJFio2 = protfio(IBcc2, Scc2, nomeDis);
    nomeDisj2 = resDisJFio2.DisjProt;
    nomeFio2 = resDisJFio2.CondFio;

    
    resDisJFio3 = protfio(IBcc3, Scc3, nomeDis);
    nomeDisj3 = resDisJFio3.DisjProt;
    nomeFio3 = resDisJFio3.CondFio;
    mark=2;
  }

  if (nCircTipoCC == 3) {
    nomeDis1 = nomeDis2 = (1.5 * nIscModCC)+1;
    nomeDis3 = (1.5 * nIscModCC)*1.1;;
    potTotalMod = nModCC * nPotModCC;
    VocTotal = nModCC * nVocModCC;
    VMaxTotal = nModCC * nVpModCC;
    IBcc4 = 1.25 * nIscModCC * 2;
    IBcc5 = 1.25 * nIscModCC * 2;
    IBcc6 = 1.25*((IBcc4 + IBcc5)/2);
    Scc4 = quedaTensao(ntrecho1, IBcc4, VMaxTotal);
    Scc5 = quedaTensao(ntrecho2, IBcc5, VMaxTotal);
    Scc6 = quedaTensao(ntrecho3, IBcc6, VMaxTotal);
    DPS = 1.1 * VocTotal;

    // Chamando a função protfio
   
    resDisJFio4 = protfio(IBcc4, Scc4, nomeDis1);
    nomeDisj4 = resDisJFio4.DisjProt;
    nomeFio4 = resDisJFio4.CondFio;

    resDisJFio5 = protfio(IBcc5, Scc5, nomeDis2);
    nomeDisj5 = resDisJFio5.DisjProt;
    nomeFio5 = resDisJFio5.CondFio;

    resDisJFio6 = protfio(IBcc6, Scc6, nomeDis3);
    nomeDisj6 = resDisJFio6.DisjProt;
    nomeFio6 = resDisJFio6.CondFio;
    mark=3;

if(nomeFio4>=nomeFio6){
while (nomeFio4>=nomeFio6){
  IBcc6 = IBcc6*1.1;
  Scc6 = quedaTensao(ntrecho3, IBcc6, VMaxTotal);
  resDisJFio6 = protfio(IBcc6, Scc6, nomeDis3);
  nomeDisj6 = resDisJFio6.DisjProt;
  nomeFio6 = resDisJFio6.CondFio;
  //alert(`IBcc6 = ${IBcc6} e Scc6 = ${Scc6}e Disj =${nomeDisj6} e nomeFio = ${nomeFio6}`);
}
}

if(nomeFio5>=nomeFio6){
while (nomeFio5>=nomeFio6){
  IBcc6= IBcc6*1.1;
  Scc6 = quedaTensao(ntrecho3, IBcc6, VMaxTotal);
  resDisJFio6 = protfio(IBcc6, Scc6, nomeDis3);
  nomeDisj6 = resDisJFio6.DisjProt;
  ...
  if (nCircTipoCC == 4) {
    nomeDis1 = nomeDis2 = nomeDis4 = nomeDis5 =(1.5 * nIscModCC)+1;
    nomeDis3 = nomeDis6 = (1.5 * nIscModCC)*1.1;
    nomeDis7 = (1.5 * nIscModCC)*1.2;
    potTotalMod = nModCC * nPotModCC;
    VocTotal = nModCC * nVocModCC;
    VMaxTotal = nModCC * nVpModCC;
    IBcc7 = IBcc8 = IBcc10 = IBcc11 = 1.25 * nIscModCC * 4;
    IBcc9 = 1.25*((IBcc7+IBcc8)/2);
    IBcc12 = 1.25*((IBcc10+IBcc11)/2);
    IBcc13 = 1.25*((IBcc9+IBcc12)/2);

    //IBcc5
    Scc7 = quedaTensao(ntrecho1, IBcc7, VMaxTotal);
    Scc8 = quedaTensao(ntrecho2, IBcc8, VMaxTotal);
    Scc9 = quedaTensao(ntrecho3, IBcc9, VMaxTotal);

    //IBcc6
    Scc10 = quedaTensao(ntrecho4, IBcc10, VMaxTotal);
    Scc11 = quedaTensao(ntrecho5, IBcc11, VMaxTotal);
    Scc12 = quedaTensao(ntrecho6, IBcc12, VMaxTotal);

    //IBcc7
    Scc13 = quedaTensao(ntrecho7, IBcc13, VMaxTotal);
    DPS = 1.1 * VocTotal;

    // Chamando a função protfio
    resDisJFio7 = protfio(IBcc7, Scc7, nomeDis1);
    nomeDisj7 = resDisJFio7.DisjProt;
    nomeFio7 = resDisJFio7.CondFio;

    resDisJFio8 = protfio(IBcc8, Scc8, nomeDis2);
    nomeDisj8 = resDisJFio8.DisjProt;
    nomeFio8 = resDisJFio8.CondFio;

    resDisJFio9 = protfio(IBcc9, Scc9, nomeDis3);
    nomeDisj9 = resDisJFio9.DisjProt;
    nomeFio9 = resDisJFio9.CondFio;

    resDisJFio10 = protfio(IBcc10, Scc10, nomeDis4);
    nomeDisj10 = resDisJFio10.DisjProt;
    nomeFio10 = resDisJFio10.CondFio;

    resDisJFio11 = protfio(IBcc11, Scc11, nomeDis5);
    nomeDisj11 = resDisJFio11.DisjProt;
    nomeFio11 = resDisJFio11.CondFio;

    resDisJFio12 = protfio(IBcc12, Scc12, nomeDis6);
    nomeDisj12 = resDisJFio12.DisjProt;
    nomeFio12 = resDisJFio12.CondFio;

    resDisJFio13 = protfio(IBcc13, Scc13, nomeDis7);
    nomeDisj13 = resDisJFio13.DisjProt;
    nomeFio13 = resDisJFio13.CondFio;
    mark=4;
   
    if(nomeFio7>=nomeFio9){
      while (nomeFio7>=nomeFio9){
        IBcc9 = IBcc9*1.1;
        Scc9 = quedaTensao(ntrecho3, IBcc9, VMaxTotal);
        resDisJFio9 = protfio(IBcc9, Scc9, nomeDis3);
        nomeDisj9 = resDisJFio9.DisjProt;
        nomeFio9 = resDisJFio9.CondFio;
        //alert(`IBcc9 = ${IBcc9} e Scc9 = ${Scc9}e Disj =${nomeDisj9} e nomeFio = ${nomeFio9}`);
      }
      }
      if(nomeFio8>=nomeFio9){
        while (nomeFio8>=nomeFio9){
          IBcc9 = IBcc9*1.1;
          Scc9 = quedaTensao(ntrecho3, IBcc9, VMaxTotal);
          resDisJFio9 = protfio(IBcc9, Scc9, nomeDis3);
          nomeDisj9 = resDisJFio9.DisjProt;
        ...
        if(nomeFio10>=nomeFio12){
          while (nomeFio10>=nomeFio12){
            IBcc12 = IBcc12*1.1;
            Scc12 = quedaTensao(ntrecho6, IBcc12, VMaxTotal);
            resDisJFio12 = protfio(IBcc12, Scc12, nomeDis6);
            nomeDisj12 = resDisJFio12.DisjProt;
          ...
          if(nomeFio11>=nomeFio12){
            while (nomeFio11>=nomeFio12){
              IBcc12 = IBcc12*1.1;
              Scc12 = quedaTensao(ntrecho6, IBcc12, VMaxTotal);
              resDisJFio12 = protfio(IBcc12, Scc12, nomeDis6);
              nomeDisj12 = resDisJFio12.DisjProt;
            ...
            if(nomeFio9>=nomeFio13){
              while (nomeFio9>=nomeFio13){
                IBcc13 = IBcc13*1.1;
                Scc13 = quedaTensao(ntrecho7, IBcc13, VMaxTotal);
                resDisJFio13 = protfio(IBcc13, Scc13, nomeDis7);
                nomeDisj13 = resDisJFio13.DisjProt;
              ...
              if(nomeFio12>=nomeFio13){
                while (nomeFio12>=nomeFio13){
                  IBcc13 = IBcc13*1.1;
                  Scc13 = quedaTensao(ntrecho7, IBcc13, VMaxTotal);
                  resDisJFio13 = protfio(IBcc13, Scc13, nomeDis7);
                  nomeDisj13 = resDisJFio13.DisjProt;
  ...
  nISC24 = 2.4*nIscModCC;
  nISC15 = 1.5*nIscModCC;
  if(mark==1){
    if (((mark - 1) * nIscModCC)> Iocpr) {
      if(nomeDisj1>nISC15){
        if(nomeDisj1< nISC24){
          if(nomeDisj1 <= Iocpr){
                  alert(`Disjuntor ou Fusível gPV (com seccionador ou não) deve ser de ${nomeDisj1}A.`);
        }else{
          alert("ERRO: Disjuntor ou Fusível gPV Maior do que a máxima corrrente reversa. ");
      }
    }else{
        alert(`ERRO: Disjuntor ou Fusível gPV Maior do que 2,4 x Isc Mod.=${nomeDisj1}A.`);
       }
      }else{alert(`ERRO: Disjuntor ou Fusível gPV menor do que 1,5 x Isc Mod.=${nomeDisj1}A`);
    } 
    }else{
      alert(
    ...
    if (((mark - 1) * nIscModCC) > Iocpr) {
      if(nomeDisj2>nISC15){
        if(nomeDisj2< nISC24){
          if(nomeDisj2 <= Iocpr){
                  alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para a série 01, deve ser de ${nomeDisj2}A.`);
        }else{
          alert("ERRO: Disjuntor ou Fusível gPV, para a série 01, Maior do que a máxima corrrente reversa. ");
      }
    }else{
        alert(`ERRO: Disjuntor ou Fusível gPV, para a série 01, Maior do que 2,4 x Isc Mod.=${nomeDisj2}A.`);
       }
      }else{alert(`ERRO: Disjuntor ou Fusível gPV, para a série 01, menor do que 1,5 x Isc Mod.=${nomeDisj2}A.`);
    } 

    if(nomeDisj3>nISC15){
      if(nomeDisj3< nISC24){
        if(nomeDisj3 <= Iocpr){
                alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para a série 02, deve ser de ${nomeDisj3}A.`);
      }else{
        alert("ERRO: Disjuntor ou Fusível gPV, para a série 02, Maior do que a máxima corrrente reversa. ");
    }
  }else{
      alert(`ERRO: Disjuntor ou Fusível gPV, para a série 02, Maior do que 2,4 x Isc Mod.=${nomeDisj3}A.`);
     }
    }else{alert(`ERRO: Disjuntor ou Fusível gPV, para a série 02, menor do que 1,5 x Isc Mod.=${nomeDisj3}A.`);
  } 
  }else if(nomeDisj2>nomeDisj3){
    alert(
      `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(0)}V, e  ${nomeDisj2}A.Caso opte por instalar proteção para a String, adote ${nomeDisj2}A.`);
    }else{
      alert(
        `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(0)}V, e  ${nomeDisj3}A. Caso opte por instalar proteção para a String, adote ${nomeDisj3}A.`);
    }alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, com L1 = ${ntrecho1} metros, com L2 = ${ntrecho2} metros. \n-->O condutor para trecho 01 de ${nomeFio2} mm²; para o trecho 02 de ${nomeFio3} mm².  \n-->O DPS deve ter valor maior do que ${DPS.toFixed(0)}V, Classe II. \n-->OBS.:Em caso de possibilidade de descagas atmosféricas, ou distância entre o sistema e o quadro CC maior do que 10m, consulte um Técnico ou Engenheiro para o dimensionamento do DPS e Sistema de aterramento.`);
    }else if(mark==3){
    if (((mark - 1) * nIscModCC) > Iocpr) {
      if(nomeDisj4>nISC15){
        if(nomeDisj4< nISC24){
          if(nomeDisj4 <= Iocpr){
                  alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para a série 01, deve ser de ${nomeDisj4}A.`);
        }else{
          alert("ERRO: Disjuntor ou Fusível gPV, para a série 01, Maior do que a máxima corrrente reversa. ");
      }
    }else{
        alert(`ERRO: Disjuntor ou Fusível gPV, para a série 01, Maior do que 2,4 x Isc Mod.=${nomeDisj4}A.`);
       }
      }else{alert(`ERRO: Disjuntor ou Fusível gPV, para a série 01, menor do que 1,5 x Isc Mod.=${nomeDisj4}A.`);
    } 

    if(nomeDisj5>nISC15){
      if(nomeDisj5< nISC24){
        if(nomeDisj5 <= Iocpr){
                alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para a série 02, deve ser de ${nomeDisj5}A.`);
      }else{
        alert("ERRO: Disjuntor ou Fusível gPV, para a série 02, Maior do que a máxima corrrente reversa. ");
    }
  }else{
      alert(`ERRO: Disjuntor ou Fusível gPV, para a série 02, Maior do que 2,4 x Isc Mod.=${nomeDisj5}A.`);
     }
    }else{alert(`ERRO: Disjuntor ou Fusível gPV, para a série 02, menor do que 1,5 x Isc Mod.=${nomeDisj5}A.`);
  } 
  if(nomeDisj6>nISC15){
    if(nomeDisj6< nISC24){
      
              alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para o geral do arranjo, deve ser de ${nomeDisj6}A.`);
   
}else{
    alert(`ERRO: Disjuntor ou Fusível gPV, para o geral do arranjo, Maior do que 2,4 x Isc Mod.=${nomeDisj6}A.`);
   }
  }else{alert(`ERRO: Disjuntor ou Fusível gPV, para o geral do arranjo, menor do que 1,5 x Isc Mod.=${nomeDisj6}A.`);
} 
  }else if(nomeDisj4>nomeDisj5){
    alert(
      `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(0)}V, e  ${nomeDisj4}A.Caso opte por instalar proteção para a String, adote ${nomeDisj4}A.`);
    }else if(nomeDisj5>nomeDisj6){
      alert(
        `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(0)}V, e  ${nomeDisj5}A. Caso opte por instalar proteção para a String, adote ${nomeDisj5}A.`);
    }else{
      alert(
        `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(0)}V, e  ${nomeDisj6}A. Caso opte por instalar proteção para a String, adote ${nomeDisj6}A.`);
    }
      alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, com L1 = ${ntrecho1} metros, com L2 = ${ntrecho2} metros, com L3 = ${ntrecho3} metros. \n-->O condutor para trecho 01 de ${nomeFio4} mm²; para o trecho 02 de ${nomeFio5} mm², o condutor para trecho 3 de ${nomeFio6} mm².  \n-->O DPS deve ter valor maior do que ${DPS.toFixed(0)}V, Classe II. \n-->OBS.:Em caso de possibilidade de descagas atmosféricas, ou distância entre o sistema e o quadro CC maior do que 10m, consulte um Técnico ou Engenheiro para o dimensionamento do DPS e Sistema de aterramento.`
      );
    }else if(mark==4){
    if (((mark - 1) * nIscModCC) >Iocpr) {
        if(nomeDisj7>nISC15){
          if(nomeDisj7< nISC24){
            if(nomeDisj7<= Iocpr){
                    alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para a série 01, deve ser de ${nomeDisj7}A.`);
          }else{
            alert("ERRO: Disjuntor ou Fusível gPV, para a série 01, Maior do que a máxima corrrente reversa. ");
        }
      }else{
          alert(`ERRO: Disjuntor ou Fusível gPV, para a série 01, Maior do que 2,4 x Isc Mod.=${nomeDisj7}A.`);
         }
        }else{alert(`ERRO: Disjuntor ou Fusível gPV, para a série 01, menor do que 1,5 x Isc Mod.=${nomeDisj7}A.`);
      } 
  
      if(nomeDisj8>nISC15){
        if(nomeDisj8< nISC24){
          if(nomeDisj8 <= Iocpr){
                  alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para a série 02, deve ser de ${nomeDisj8}A.`);
        }else{
          alert("ERRO: Disjuntor ou Fusível gPV, para a série 02, Maior do que a máxima corrrente reversa. ");
      }
    }else{
        alert(`ERRO: Disjuntor ou Fusível gPV, para a série 02, Maior do que 2,4 x Isc Mod.=${nomeDisj8}A.`);
       }
      }else{alert(`ERRO: Disjuntor ou Fusível gPV, para a série 02, menor do que 1,5 x Isc Mod.=${nomeDisj8}A.`);
    } 
    if(nomeDisj9>nISC15){
      if(nomeDisj9< nISC24){
        
                alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para o subarranjo 01, deve ser de ${nomeDisj9}A.`);
       }else{
      alert(`ERRO: Disjuntor ou Fusível gPV, para o subarranjo 01, Maior do que 2,4 x Isc Mod.=${nomeDisj9}A.`);
     }
    }else{alert(`ERRO: Disjuntor ou Fusível gPV, para o subarranjo 01, menor do que 1,5 x Isc Mod.=${nomeDisj9}A.`);
  } 
  if(nomeDisj10>nISC15){
    if(nomeDisj10< nISC24){
      if(nomeDisj10 <= Iocpr){
              alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para a série 03, deve ser de ${nomeDisj10}A.`);
    }else{
      alert("ERRO: Disjuntor ou Fusível gPV, para a série 03, Maior do que a máxima corrrente reversa. ");
  }
}else{
    alert(`ERRO: Disjuntor ou Fusível gPV, para a série 03, Maior do que 2,4 x Isc Mod.=${nomeDisj10}A.`);
   }
  }else{alert(`ERRO: Disjuntor ou Fusível gPV, para a série 03, menor do que 1,5 x Isc Mod.=${nomeDisj10}A.`);
} 
if(nomeDisj11>nISC15){
  if(nomeDisj11< nISC24){
    if(nomeDisj11<= Iocpr){
            alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para a série 04, deve ser de ${nomeDisj11}A.`);
  }else{
    alert("ERRO: Disjuntor ou Fusível gPV, para a série 04, Maior do que a máxima corrrente reversa. ");
}
}else{
  alert(`ERRO: Disjuntor ou Fusível gPV, para a série 04, Maior do que 2,4 x Isc Mod.= ${nomeDisj11}A.`);
 }
}else{alert(`ERRO: Disjuntor ou Fusível gPV, para a série 04, menor do que 1,5 x Isc Mod.=${nomeDisj11}A.`);
} 
if(nomeDisj12>nISC15){
  if(nomeDisj12< nISC24){
       alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para o subarranjo 02, deve ser de ${nomeDisj12}A.`); 
}else{
  alert(`ERRO: Disjuntor ou Fusível gPV, para o subarranjo 02, Maior do que 2,4 x Isc Mod.=${nomeDisj12}A.`);
 }
}else{alert(`ERRO: Disjuntor ou Fusível gPV, , para o subarranjo 02, menor do que 1,5 x Isc Mod.=${nomeDisj12}A.`);
} 
if(nomeDisj13>nISC15){
  if(nomeDisj13< nISC24){
    
            alert(`Disjuntor ou Fusível gPV (com seccionador ou não), para o geral do arranjo, deve ser de ${nomeDisj13}A.`);
 }else{
  alert(`ERRO: Disjuntor ou Fusível gPV, para o geral do arranjo, Maior do que 2,4 x Isc Mod.=${nomeDisj13}A.`);
 }
}else{alert(`ERRO: Disjuntor ou Fusível gPV, para o geral do arranjo, menor do que 1,5 x Isc Mod.=${nomeDisj13}A.`);
} 
    }else if(nomeDisj11>nomeDisj12){
      alert(
        `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(0)}V, e  ${nomeDisj11}A. Caso opte por instalar proteção para os Subarranjos com 04 strings, adote ${nomeDisj11}A.`);
      }else if(nomeDisj12>nomeDisj11){
        alert(
          `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(0)}V, e  ${nomeDisj12}A. Caso opte por instalar proteção para os Subarranjos com 04 strings, adote ${nomeDisj12}A.`);
      }else{
        alert(
          `Esta série(séries) não necessitam de proteção. O seccionador da StringBox deve suportar no mínimo ${DPS.toFixed(0)}V, e  ${nomeDisj13}A. Caso opte por instalar proteção para o Arranj0, adote ${nomeDisj13}A.`);
      }
      alert(
        `Sistema ${nCircC}, com ${potTotalMod}Wp, com L1 = ${ntrecho1} metros, com L2 = ${ntrecho2} metros,  com L3 = ${ntrecho3} metros,  com L4 = ${ntrecho4} metros,   com L5 = ${ntrecho5} metros,   com L6 = ${ntrecho6} metros,   com L7 = ${ntrecho7} metros. \n-->O condutor para trecho 01 de ${nomeFio7} mm²; para o trecho 02 de ${nomeFio8} mm², o condutor para trecho 3 de ${nomeFio9} mm², o condutor para o trecho 04 de ${nomeFio10} mm², para o trecho 05 de ${nomeFio11} mm², o condutor para o trecho 06 de ${nomeFio12}mm², e o condutor para o trecho 07 de ${nomeFio13} mm².  \n-->O DPS deve ter valor maior do que ${DPS.toFixed(0)}V, Classe II. \n-->OBS.:Em caso de possibilidade de descagas atmosféricas, ou distância entre o sistema e o quadro CC maior do que 10m, consulte um Técnico ou Engenheiro para o dimensionamento do DPS e Sistema de aterramento.`);
    }
} 
...
function dimensCirc() {
  ...
  if (nomeCCarregado == 1) {
    ...
    if (nomeDisj == 0 || nomeFio == 0 || nomeFio2 == 0 || nomeFio3 == 0) {
      alert(
        "ERRO: Condutor superou 25mm² em, pelo menos, um dos critérios de dimensionamento. Consulte um técnico ou refaça o dimensionamento."
      );
    } else {
      alert(
